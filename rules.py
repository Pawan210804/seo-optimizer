...
def check_keyword_in_first_paragraph(content, keyword):
    if not keyword:
        return {"name": "Keyword placement", "score": 100, "passed": True,
                "message": "No focus keyword supplied - check skipped.",
                "fix": "Provide a focus keyword to get placement guidance."}
...
def check_keyword_density(content, keyword):
    ...
    if not keyword or word_count == 0:
        return {"name": "Keyword density", "score": 100, "passed": True,
                "message": "No focus keyword supplied - check skipped.",
                "fix": "Provide a focus keyword to get density guidance."}
...
def check_image_alt_text(content):
    ...
    return {"name": "Image alt text", "score": percentage, "passed": passed, "message": message, "fix": fix}
