...
def _clean_bullet_line(line):
    ...
    # being asked not to, and pulls off a leading priority tag if
    # present. Identical to gemini_seo.py so both sources produce the
    # same shape regardless of the underlying model.
    #
